...
class FormattingManager {
    constructor(context, configurationManager) {
        ...
        context.subscriptions.push(vscode_1.languages.registerDocumentFormattingEditProvider(mod_1.default(), this), vscode_1.languages.registerDocumentRangeFormattingEditProvider(mod_1.default(), this));
    }
        ...
        return new Promise((resolve, reject) => {
            ...
            cp.execFile(this.configurationManager.getRustfmtPath(), args, { env: env }, (err, stdout, stderr) => {
                try {
                    ...
                    let hasFatalError = (err && err.code < 3);
    ...
    parseDiff(fileToProcess, diff) {
        ...
        let textEdits = patches.map(patch => {
            ...
            let range = new vscode_1.Range(startLine, 0, endLine, Number.MAX_SAFE_INTEGER);
...
exports.default = FormattingManager;
