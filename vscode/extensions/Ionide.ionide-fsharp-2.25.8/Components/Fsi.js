...
function sendCd() {
  ...
  var msg2 = _fableCore.String.fsFormat("# %d @\"%s\" \n")(function (x) {
    return x;
  })(1)(patternInput[0]);
...
function start() {
  return _Helpers.Promise.onFail(function (_arg1) {
    ...
    var terminal = _vscode.window.createTerminal("F# Interactive", _Environment.fsi, parms);
...
function chunkStringBySize(size, str) {
  var i1 = 0;
  return _fableCore.Seq.toList(_fableCore.Seq.delay(function () {
    return _fableCore.Seq.enumerateWhile(function () {
      return i1 < str.length;
    }, _fableCore.Seq.delay(function () {
      var i2 = i1 + size < str.length ? i1 + size : str.length;
      return _fableCore.Seq.append(_fableCore.Seq.singleton(str.slice(i1, i2 - 1 + 1)), _fableCore.Seq.delay(function () {
        i1 = i2;
...
function send(msg) {
  ...
  return _Helpers.Promise.onFail(function (error) {
    ...
    _fableCore.Seq.iterate(function (x) {
      fp.sendText(x, false);
    }, chunkStringBySize(256, msgWithNewline));
