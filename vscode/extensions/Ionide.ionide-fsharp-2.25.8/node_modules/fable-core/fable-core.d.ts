...
declare class FMap<K, V> implements IEquatable<FMap<K, V>>, IComparable<FMap<K, V>>, Iterable<[K, V]> {
    ...
    static create<K, V>(ie?: Iterable<[K, V]>, comparer?: IComparer<K>): FMap<K, V>;
    ToString(): string;
    ...
    clear(): void;
    size: number;
    static add<K, V>(k: K, v: V, map: FMap<K, V>): FMap<K, V>;
    static remove<K, V>(item: K, map: FMap<K, V>): FMap<K, V>;
    static containsValue<K, V>(v: V, map: Map<K, V> | FMap<K, V>): boolean;
    static exists<K, V>(f: (k: K, v: V) => boolean, map: FMap<K, V>): boolean;
    static find<K, V>(k: K, map: FMap<K, V>): V;
    static tryFind<K, V>(k: K, map: FMap<K, V>): V;
    static filter<K, V>(f: (k: K, v: V) => boolean, map: FMap<K, V>): FMap<K, V>;
    static fold<K, V, ST>(f: (acc: ST, k: K, v: V) => ST, seed: ST, map: FMap<K, V>): ST;
    static foldBack<K, V, ST>(f: (k: K, v: V, acc: ST) => ST, map: FMap<K, V>, seed: ST): ST;
    ...
    static map<K, T, U>(f: (k: K, v: T) => U, map: FMap<K, T>): FMap<K, U>;
    static partition<K, V>(f: (k: K, v: V) => boolean, map: FMap<K, V>): [FMap<K, V>, FMap<K, V>];
    ...
    static pick<K, T, U>(f: (k: K, v: T) => U, map: FMap<K, T>): U;
    static tryPick<K, T, U>(f: (k: K, v: T) => U, map: FMap<K, T>): U;
}
export { FMap as Map };
